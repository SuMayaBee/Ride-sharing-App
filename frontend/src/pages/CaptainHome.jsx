    ...
    useEffect(() => {
        if (captain && captain._id) {
            ...
            const updateLocation = () => {
                console.log('=== FRONTEND: Attempting to update location ===');
                console.log('Navigator geolocation available:', !!navigator.geolocation);
                console.log('Captain data:', captain ? 'Available' : 'Not available');
                ...
                if (navigator.geolocation && captain && captain._id) {
                    ...
                    console.log('- Captain ID available:', !!captain?._id);
                }
            }
